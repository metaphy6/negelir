...
def test_boot_with_lineage_floor_met_emits_legacy_backfill_without_warn_flood(
    ...
    from swarm.agents.maint import backup as backup_module
    from swarm.agents.maint import model_lineage as lineage_module
...
def test_verify_mode_invalid_value_refuses_boot(
    ...
    nightly verify."""
    from swarm.agents.maint.backup import BackupConfigError
...
def test_bootstrap_includes_backup_agent(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    from swarm.bootstrap import SINGLE_INSTANCE_AGENTS, build_agents
...
def test_boot_refuses_when_lineage_writer_prerequisite_not_met(
    ...
    from swarm.agents.maint.backup import BackupConfigError, RegistryAuditor
    from swarm.agents.maint.model_lineage import LineagePrerequisiteError
