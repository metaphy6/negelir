...
def test_verify_envelope_signature_importable() -> None:
    ...
    from swarm.agents.maint._op_signature import verify_envelope_signature  # noqa: F401


def test_verify_envelope_signature_callable() -> None:
    """verify_envelope_signature must be callable (§8.15.4)."""
    from swarm.agents.maint._op_signature import verify_envelope_signature
...
def test_truncate_oversize_importable() -> None:
    ...
    from swarm.sdk.maint_audit import truncate_oversize  # noqa: F401
...
def test_catalogue_importable() -> None:
    ...
    from swarm.agents.maint._catalogue import CATALOGUE  # noqa: F401


def test_catalogue_has_at_least_five_entries() -> None:
    """CATALOGUE must contain ≥ 5 AgentCatalogueRow entries (§8.15.6)."""
    from swarm.agents.maint._catalogue import CATALOGUE
...
def test_shed_state_store_importable() -> None:
    ...
    from swarm.sdk.shed_state import ShedStateStore  # noqa: F401
