...
make orchestrate.advance PHASE=<id> ROLE=verifier \
    OUTCOME=ok STATUS=completed MODEL="gpt-5-codex" \
...
make orchestrate.advance PHASE=<id> ROLE=verifier \
    OUTCOME=needs-changes STATUS=implementing MODEL="gpt-5-codex" \
...
make orchestrate.advance PHASE=<id> ROLE=verifier \
    OUTCOME=blocked STATUS=blocked MODEL="gpt-5-codex" \
