# Datasource_Scraper — Public API

> **Component:** datasource_scraper
> **Frozen:** Phase 18.5 (§18.5 ledger #7)
> **Generated from:** `datasource_scraper/__init__.py::__all__`
> **Last regenerated:** Phase 18.5 (via `make docs.api`)

This document is **auto-generated** from the `__all__` declaration in
`datasource_scraper/__init__.py`. Do not edit by hand; regenerate with:
