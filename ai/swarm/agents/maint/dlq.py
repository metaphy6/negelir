...
RECURSION_DENY_SET: frozenset[str] = frozenset({
    # Phase 8 §8.14.5 core fix: the supervisor's own DLQ. Replaying
    # maint.dlq.v1.dlq would cause the supervisor to subscribe to
    # itself — every failure spawns a replay attempt, infinitely.
    "maint.dlq.v1.dlq",
